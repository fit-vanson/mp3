    ...
    public function getIndex(Request $request)
    {
       ...
       // Total records
        ...
        foreach ($records as $record) {
            ...
            $music_ytb      = checkLink('https://www.youtube.com/watch?v='.$record->music_id_ytb)  ?   '<h5 class="mt-0 font-16">YTB</h5><audio class="audio-player" controls><source src="'.$this->getLinkUrl($record->music_id_ytb,'url').'" type="audio/mp3"/></audio>' : null ;
